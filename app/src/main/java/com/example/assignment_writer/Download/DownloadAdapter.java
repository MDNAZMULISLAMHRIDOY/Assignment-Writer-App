...
import com.example.assignment_writer.EditPage.DownloadView;
...
public class DownloadAdapter extends RecyclerView.Adapter<DownloadAdapter.ViewHolder> {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.download_view,parent,false));
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.delete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String key = preferences.getString("profileKey", null);
                ...
                if (key != null) {
                    ...
                    DatabaseReference reference = FirebaseDatabase.getInstance().getReference("Users").child(key).child("download");
